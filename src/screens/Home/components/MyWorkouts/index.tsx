...
const MyWorkouts: React.FC = () => {
    ...
    const { filteredWorkouts, onChangeSearchWorkoutInput, searchWorkout, searchWorkoutInput, workoutsRealm } = useMyWorkouts()

    const data = searchWorkoutInput ? searchWorkout : filteredWorkouts ? filteredWorkouts : workoutsRealm
