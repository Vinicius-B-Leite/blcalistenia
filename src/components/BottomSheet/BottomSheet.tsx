...
export const BottomSheet = React.forwardRef<BottomSheetRefProps, Props>(
  ({children, onClose}, ref) => {
    ...
    const scrollTo = useCallback(
      ({destination, duration, enableEndFuntion}: ScrollToProps) => {
        'worklet';
        animatedHeigh.value = withTiming(
          destination,
    ...
    useImperativeHandle(ref, () => ({scrollTo, isVisible}), [
      scrollTo,
      isVisible,
    ]);
