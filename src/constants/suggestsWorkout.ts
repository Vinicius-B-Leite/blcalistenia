...
export const suggests: SuggestWorkoutType[] = [
  {
    ...
    workout: JSON.stringify({
      _id: 'suggestWorkout1',
      banner:
        'https://previous-assets.menshealth.pt/files/2017/09/iStock-1094479308.jpg',
      title: 'Flexão',
      exercises: [
        {
  ...
  },
  {
    ...
    workout: JSON.stringify({
      _id: 'suggestWorkout2',
      banner:
        'https://www.blog.bioritmo.com.br/wp-content/uploads/2021/10/shutterstock_753521752-1.jpg',
      title: 'Barra fixa',
      exercises: [
        {
  ...
  },
  {
    ...
    workout: JSON.stringify({
      _id: 'suggestWorkout3',
      banner:
        'https://img.freepik.com/premium-photo/man-doing-handstand-push-ups-bars_126745-1514.jpg?w=2000',
  ...
  },
  {
    ...
    workout: JSON.stringify({
      _id: 'suggestWorkout4',
      banner:
        'https://media.istockphoto.com/id/1196816311/pt/foto/athlete-doing-a-typewriter-archer-pull-up.jpg?s=170667a&w=0&k=20&c=ssP4GKcTN4O4qyDgnZX6P3S4BkZCiE23UocNqlWjw8g=',
